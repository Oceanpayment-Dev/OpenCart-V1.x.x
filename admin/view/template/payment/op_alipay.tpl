        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="op_alipay_account" value="<?php echo $op_alipay_account; ?>" />
	     ...
	     <tr>
              ...
              <td><input type="text" name="op_alipay_terminal" value="<?php echo $op_alipay_terminal; ?>" />
            ...
            <tr>
              ...
              <td><input type="text" name="op_alipay_securecode" value="<?php echo $op_alipay_securecode; ?>" />
            ...
            <tr>
              ...
              <td><select name="op_alipay_transaction">
            ...
            <tr>
              ...
              <td><select name="op_alipay_default_order_status_id">
    		...
    		<tr>
              ...
              <td><select name="op_alipay_success_order_status_id">
                  <?php foreach ($order_statuses as $order_status) { ?>
    		...
    		<tr>
              ...
              <td><select name="op_alipay_failed_order_status_id">
                  <?php foreach ($order_statuses as $order_status) { ?>
            ...
            <tr>
              ...
              <td><select name="op_alipay_pending_order_status_id">
                  <?php foreach ($order_statuses as $order_status) { ?>
            ...
            <tr>
              ...
              <td><select name="op_alipay_geo_zone_id">
            ...
            <tr>
              ...
              <td><select name="op_alipay_code">
                  <?php if ($op_alipay_code) { ?>
            ...
            <tr>
              ...
              <td><select name="op_alipay_status">
            ...
            <tr>
              ...
              <td><input type="text" name="op_alipay_sort_order" value="<?php echo $op_alipay_sort_order; ?>" size="1" /></td>
            </tr>
          </table>
        </form>
      </div>
