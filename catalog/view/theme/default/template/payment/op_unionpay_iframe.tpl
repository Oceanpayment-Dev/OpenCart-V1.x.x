...
<form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" id="checkout_unionpay" name="checkout_unionpay">
...
<iframe width="100%" height="340" scrolling="auto" name="ifrm_unionpay_checkout" id="ifrm_unionpay_checkout" style="border:none; margin: 0 auto; overflow:hidden;"></iframe>

<script type="text/javascript">
<?php if($_SESSION['pages']=='0'){?>
if (window.XMLHttpRequest) {
document.checkout_unionpay.target="ifrm_unionpay_checkout";
}
<?php }?>
document.checkout_unionpay.submit();
window.status = "<?php echo $action;?>";
</script>
<script type="text/javascript">
    var ifrm_cc  = document.getElementById("ifrm_unionpay_checkout");
