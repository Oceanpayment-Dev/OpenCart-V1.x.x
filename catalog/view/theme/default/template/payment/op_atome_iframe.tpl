...
<form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" id="checkout_atome" name="checkout_atome">
...
<iframe width="100%" height="340" scrolling="auto" name="ifrm_atome_checkout" id="ifrm_atome_checkout" style="border:none; margin: 0 auto; overflow:hidden;"></iframe>

<script type="text/javascript">
<?php if($_SESSION['pages']=='0'){?>
if (window.XMLHttpRequest) {
document.checkout_atome.target="ifrm_atome_checkout";
}
<?php }?>
document.checkout_atome.submit();
window.status = "<?php echo $action;?>";
</script>
<script type="text/javascript">
    var ifrm_cc  = document.getElementById("ifrm_atome_checkout");
